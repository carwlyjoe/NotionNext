...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aiexplorernote.com/', // 网站地址
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://notion.com', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
